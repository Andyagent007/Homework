// Use fetch to get the JSON from the internet -https://developer.mozilla.org/es/docs/Web/API/Fetch_API
// But before using fetch do this:
planets = [
	{"position": "1",
	 "name": "Mercury",
...
console.log("<thead>")
console.log("<tr>")
console.log("<td>planets</td>")
console.log("</tr>")
console.log("<tr>")
for(let col = 0; col<columns.length; col++){
  console.log(`<td>${columns[col]}</td>`)
}
console.log("</tr>")
console.log("</thead>")
